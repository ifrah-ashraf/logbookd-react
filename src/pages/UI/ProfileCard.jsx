    ...
    return (
        <div className="max-w-lg mx-auto bg-gray-400 shadow-md rounded-lg mt-4 overflow-hidden">
            ...
            <div className="text-center mt-4">
                ...
                <h3 className="mt-2 text-start ml-2 font-semibold">Year of Passing</h3>
                <p className="text-gray-600 text-left ml-2">{profile.year_of_passing}</p>

                <h3 className="mt-2 text-start ml-2 font-semibold">Skills</h3>
                <p className="text-gray-600 text-left ml-2">{profile.skills.join(', ')}</p>
                ...
                <div className="flex justify-center mt-4">
                    <a href={profile.github_profile} target="_blank" rel="noopener noreferrer" className="mx-2 text-gray-600 hover:text-gray-800">
                    ...
                    <a href={profile.linkedin_profile} target="_blank" rel="noopener noreferrer" className="mx-2 text-gray-600 hover:text-gray-800">
                        <svg fill="currentColor" className="h-6 w-6" viewBox="0 0 24 24">
