    ...
    return (
        <div className="max-w-lg mx-auto  bg-gray-400 shadow-md rounded-lg mt-4 overflow-hidden">
            ...
            <div className="text-center mt-4">
                ...
                <p className=" text-gray-600 text-left ml-2">{profile.year_of_passout}</p>

                <h3 className='mt-2 text-start ml-2 font-semibold'>Domain </h3>
                <p className=" text-gray-600 text-left ml-2">{profile.tech_skills.join(', ')}</p>
                ...
                <div className="flex justify-center mt-4">
                    <a href={profile.github_profile} className="mx-2 text-gray-600 hover:text-gray-800">
                    ...
                    <a href={profile.linkedin_profile} className="mx-2 text-gray-600 hover:text-gray-800">
                        <svg fill="currentColor" className="h-6 w-6" viewBox="0 0 24 24">
